...
public class Reference {
    ...
    public static final ItemSpooky SPOOKY = new ItemSpooky(new Item.Settings().group(Reference.itemGroup));
    public static final ItemXmas XMAS = new ItemXmas(new Item.Settings().group(Reference.itemGroup));
    ...
    public static void registration() {
        ...
        IRON_FURNACE_TILE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Reference.MOD_ID, BlockIronFurnace.IRON_FURNACE), FabricBlockEntityTypeBuilder.create(BlockIronFurnaceTile::new, IRON_FURNACE).build(null));
        IRON_FURNACE_SCREEN_HANDLER = ScreenHandlerRegistry.registerExtended(new Identifier(Reference.MOD_ID, BlockIronFurnace.IRON_FURNACE), BlockIronFurnaceScreenHandler::new);

        registerBlock(BlockGoldFurnace.GOLD_FURNACE, GOLD_FURNACE);
        GOLD_FURNACE_TILE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Reference.MOD_ID, BlockGoldFurnace.GOLD_FURNACE), FabricBlockEntityTypeBuilder.create(BlockGoldFurnaceTile::new, GOLD_FURNACE).build(null));
        GOLD_FURNACE_SCREEN_HANDLER = ScreenHandlerRegistry.registerExtended(new Identifier(Reference.MOD_ID, BlockGoldFurnace.GOLD_FURNACE), BlockGoldFurnaceScreenHandler::new);

        registerBlock(BlockDiamondFurnace.DIAMOND_FURNACE, DIAMOND_FURNACE);
        DIAMOND_FURNACE_TILE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Reference.MOD_ID, BlockDiamondFurnace.DIAMOND_FURNACE), FabricBlockEntityTypeBuilder.create(BlockDiamondFurnaceTile::new, DIAMOND_FURNACE).build(null));
        DIAMOND_FURNACE_SCREEN_HANDLER = ScreenHandlerRegistry.registerExtended(new Identifier(Reference.MOD_ID, BlockDiamondFurnace.DIAMOND_FURNACE), BlockDiamondFurnaceScreenHandler::new);

        registerBlock(BlockEmeraldFurnace.EMERALD_FURNACE, EMERALD_FURNACE);
        EMERALD_FURNACE_TILE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Reference.MOD_ID, BlockEmeraldFurnace.EMERALD_FURNACE), FabricBlockEntityTypeBuilder.create(BlockEmeraldFurnaceTile::new, EMERALD_FURNACE).build(null));
        EMERALD_FURNACE_SCREEN_HANDLER = ScreenHandlerRegistry.registerExtended(new Identifier(Reference.MOD_ID, BlockEmeraldFurnace.EMERALD_FURNACE), BlockEmeraldFurnaceScreenHandler::new);

        registerBlock(BlockCrystalFurnace.CRYSTAL_FURNACE, CRYSTAL_FURNACE);
        CRYSTAL_FURNACE_TILE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Reference.MOD_ID, BlockCrystalFurnace.CRYSTAL_FURNACE), FabricBlockEntityTypeBuilder.create(BlockCrystalFurnaceTile::new, CRYSTAL_FURNACE).build(null));
        CRYSTAL_FURNACE_SCREEN_HANDLER = ScreenHandlerRegistry.registerExtended(new Identifier(Reference.MOD_ID, BlockCrystalFurnace.CRYSTAL_FURNACE), BlockCrystalFurnaceScreenHandler::new);

        registerBlock(BlockObsidianFurnace.OBSIDIAN_FURNACE, OBSIDIAN_FURNACE);
        OBSIDIAN_FURNACE_TILE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Reference.MOD_ID, BlockObsidianFurnace.OBSIDIAN_FURNACE), FabricBlockEntityTypeBuilder.create(BlockObsidianFurnaceTile::new, OBSIDIAN_FURNACE).build(null));
        OBSIDIAN_FURNACE_SCREEN_HANDLER = ScreenHandlerRegistry.registerExtended(new Identifier(Reference.MOD_ID, BlockObsidianFurnace.OBSIDIAN_FURNACE), BlockObsidianFurnaceScreenHandler::new);

        registerBlock(BlockNetheriteFurnace.NETHERITE_FURNACE, NETHERITE_FURNACE);
        NETHERITE_FURNACE_TILE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Reference.MOD_ID, BlockNetheriteFurnace.NETHERITE_FURNACE), FabricBlockEntityTypeBuilder.create(BlockNetheriteFurnaceTile::new, NETHERITE_FURNACE).build(null));
        NETHERITE_FURNACE_SCREEN_HANDLER = ScreenHandlerRegistry.registerExtended(new Identifier(Reference.MOD_ID, BlockNetheriteFurnace.NETHERITE_FURNACE), BlockNetheriteFurnaceScreenHandler::new);

        registerBlock(BlockCopperFurnace.COPPER_FURNACE, COPPER_FURNACE);
        COPPER_FURNACE_TILE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Reference.MOD_ID, BlockCopperFurnace.COPPER_FURNACE), FabricBlockEntityTypeBuilder.create(BlockCopperFurnaceTile::new, COPPER_FURNACE).build(null));
        COPPER_FURNACE_SCREEN_HANDLER = ScreenHandlerRegistry.registerExtended(new Identifier(Reference.MOD_ID, BlockCopperFurnace.COPPER_FURNACE), BlockCopperFurnaceScreenHandler::new);

        registerBlock(BlockSilverFurnace.SILVER_FURNACE, SILVER_FURNACE);
        SILVER_FURNACE_TILE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Reference.MOD_ID, BlockSilverFurnace.SILVER_FURNACE), FabricBlockEntityTypeBuilder.create(BlockSilverFurnaceTile::new, SILVER_FURNACE).build(null));
        SILVER_FURNACE_SCREEN_HANDLER = ScreenHandlerRegistry.registerExtended(new Identifier(Reference.MOD_ID, BlockSilverFurnace.SILVER_FURNACE), BlockSilverFurnaceScreenHandler::new);

        Registry.register(Registry.BLOCK, new Identifier(Reference.MOD_ID, BlockWirelessHeater.HEATER), WIRELESS_HEATER);
        Registry.register(Registry.ITEM, new Identifier(Reference.MOD_ID, BlockWirelessHeater.HEATER), new BlockItemHeater(WIRELESS_HEATER, new Item.Settings().group(itemGroup)));
        WIRELESS_HEATER_TILE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Reference.MOD_ID, BlockWirelessHeater.HEATER), FabricBlockEntityTypeBuilder.create(BlockWirelessHeaterTile::new, WIRELESS_HEATER).build(null));
